package sport.user.alipay.util;
...
public class AlipayConfig {
	...
	// 商户的私钥
	public static String private_key ="MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAMaijbswtT7BCcy5"
			...
			+ "CrWvTABwjpVmmA==";
	public static String public_key="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDGoo27MLU+wQnMueanZn3ORZfs"
			+ "wVDcG+W/1S5DJX7e9dVL+IjAfmSPSeWZPpCc6mE/yoAMi6PxlOZHE3mDnUfb99we"
			+ "1ozqMUHYsPexk+7uHQScnoHGF8UDpzdlxCex4hl8wcC8OIH3QkHYqoAqEioGunXw"
			+ "/mGIvMt5HWHLfAeD9wIDAQAB";
